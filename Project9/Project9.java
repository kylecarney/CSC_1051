//********************************************************************
//  Project9.java       Author: Kyle Carney
//
...
public class Project9
{
   ...
   {  //counters to print histogram
      ...
      System.out.println ("Please enter your numbers (in range 1... 100)" +
                          ", terminated by -1\n");
      ...
      String input = keyboard.nextLine();
        ...
        // This splits up the string every at every space and stores 
        //these values in an array called numbersStr.
        // (e.g. if the input variable is 
        // "1 2 3", numbersStr would be {"1", "2", "3"} )
      String[] numbersStr = input.split(" ");
   
        // This makes an int[] array the same length as our string array
        // called numbers. This is how each # is stored as an integer 
