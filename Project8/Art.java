//************************************************************************
//  Art.Java            Author: Kyle Carney
//
//  Project 8 
//  Demonstrates the translation of shapes and elements in JavaFX
//************************************************************************
...
public class Art extends Application
{
   ...
   { 
      ...
      //Pacman circle     
      Circle pacman = new Circle(r, 480, 15);
      ...
      triangle1.setFill(background);
      triangle1.setStroke(background);  
      ...
      triangle2.setFill(background);
      triangle2.setStroke(background);  
      ...
      //Scene root, 580x660, random background
      Scene scene = new Scene(root, 580, 660, background);
