//************************************************************************
//  FancySnowman.java       Author: Kyle Carney
//  Lab 9
...
public class FancySnowman extends Application
{
   ...
   {  
      ...
      Line extraRay = new Line(0, 5, 25, 60);
      extraRay.setStroke(Color.YELLOW);
      extraRay.setStrokeWidth(2);
      rays.getChildren().add(extraRay);
